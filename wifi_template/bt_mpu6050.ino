...
// // const char * host = "172.29.34.245"; // leeds?
// // const char * host = "172.29.21.183"; // laptop
...
//   SerialBT.println(String(g.gyro.x) + "," + String(g.gyro.y) + "," + String(g.gyro.z) + "," + String(a.acceleration.x) + "," + String(a.acceleration.y) + "," + String(a.acceleration.z)+ "," + String(temp.temperature));
