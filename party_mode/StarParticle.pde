...
class StarParticle extends Particle {
  ...
  void display(int ps_lifespan) {
    ...
    //fill(255,255,0);
    if(output_state == 5 || (output_state == 0 && prev_output_state == 5)) {
      star(0,0, 30, 60, 5); 
    }
    else if(output_state == 4 || (output_state == 0 && prev_output_state == 4) ) {
      star(0,0, 5, 10, 5); 
    }
    else if(output_state == 1 || output_state == 9 || (output_state == 0 && prev_output_state == 1) || (output_state == 0 && prev_output_state == 9) ) {
      rotate(-frameCount / 50.0);
      beginShape();
      vertex(50, 15);
